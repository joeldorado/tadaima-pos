...
export const ROUTE_HELP: RouteHelp[] = [
  ...
  // TODO: cambiar a "historial-ventas" cuando exista ese tema — hoy el
  // historial de tickets no tiene tutorial propio y Reportes es lo más cercano.
  { pattern: /^\/sales(?:\/|$)/, topic: "reportes" },
  ...
  { pattern: /^\/buscar-tiendas(?:\/|$)/, topic: "existencias" },
